...
const Contact = ({ ui }: TContactProps) => {
  return (
    <div id="contact-container" className={`relative max-w-[2048px] mx-auto h-[88vh] p-5`}>
        ...
        <h1 className="relative text-center dark:text-white text-slate-900 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">CONTACT</h1>
